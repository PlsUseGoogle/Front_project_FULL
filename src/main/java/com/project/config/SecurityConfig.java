    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/index", "/index.html", "/register", "/register.html", "/error", "/css/**", "/js/**", "/images/**").permitAll()
                        .requestMatchers("/projektEdit", "/zadanieEdit", "/zadanieSave", "/zadanieDelete").hasRole("ADMIN")
                        .requestMatchers("/studentAdd", "/studentSave", "/studentEdit", "/studentDelete", "/studentList").hasRole("ADMIN")
                        .requestMatchers("/projektList", "/projektView", "/zadanieList").hasAnyRole("USER", "ADMIN")
